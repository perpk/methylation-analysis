...
saveRDS(
    ...
    file.path(project_context$paths$processed, "GSE145361_pca_df_enriched_meta.rds")
)
...
pca_pairplot <- function(pca_df_with_dates, color_by = NULL, size_factor = 3, n_pcs = 6) {
    ...
    ggsave(file.path(project_context$paths$plots, paste0("GSE145361_pca_pairplot_", color_by, ".png")),
        pplot,
