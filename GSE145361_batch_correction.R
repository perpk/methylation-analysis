...
targets <- readRDS(file.path(project_context$paths$processed, "GSE145361_harmonized_targets.rds"))
m_values <- readRDS(file.path(project_context$paths$processed, "GSE145361_harmonized_m_values.rds"))
...
saveRDS(combat_m_values, file.path(project_context$paths$results, "GSE145361_combat_m_values.rds"))
...
saveRDS(
    ...
    file.path(project_context$paths$processed, "GSE145361_pca_df_enriched_meta_after_combat.rds")
)
...
pca_pairplot <- function(pca_df_with_dates, color_by = NULL, size_factor = 3, n_pcs = 6) {
    ...
    ggsave(file.path(project_context$paths$plots, paste0("GSE145361_pca_pairplot_after_combat", color_by, ".png")),
        pplot,
