...
peg1_common_probes = list(set(peg1_probes['IlmID']).intersection(set(manifest_df['IlmnID'])))
ppmi_common_probes = list(set(ppmi_probes['IlmID']).intersection(set(manifest_df['IlmnID'])))
...
consensus_probes = mapped_enhancers_peg1.intersection(mapped_enhancers_ppmi)
