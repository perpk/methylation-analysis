...
filename = "consolidated_pd_network_enrichment_results.csv"
...
for cohort_name, file_path in cohort_files.items():
    ...
    axes[0].set_title(f'{cohort_name.upper()} corrected significant terms')
    ...
    axes[1].set_title(f'{cohort_name.upper()} nominally significant terms')
