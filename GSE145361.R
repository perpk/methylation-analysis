...
data_folder <- paste0("/root/workspace/methyl-pipe-out/", project_name, "_RAW")
...
# saveRDS(targets, file.path("/root/workspace/methyl-pipe-out/GSE145361_20260522_110341/raw_data", "targets.rds"))
