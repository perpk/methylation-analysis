...
pre_process_eda <- function(project_name = NULL, project_to_load = NULL, targets = NULL, data_folder = NULL, project_location = NULL, var_mapping = NULL) {

  source('R/progress_mgr.R')
  source('R/project_context.R')
  if (is.null(project_to_load)) {
    #### Create a new project
    project_context <- create_methylation_project(project_name, project_location)
  } else {
    #### Load an existing project
    project_context <- .load_methylation_project(project_location, project_to_load)
  }
